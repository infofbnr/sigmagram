...
function showService() {
    ...
    if (selectedService === 'tiktok') {
        serviceText = `
            ...
            - TikTok Followers: 3.85$ / 1,000 
            <input type="number" id="followers-quantity" placeholder="Qty (e.g., 5000)" min="1" oninput="updatePrice('TikTok Followers', 3.85, 'followers-quantity')">
            <span class="price-display" id="price-followers">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('TikTok Followers', 3.85, document.getElementById('followers-quantity').value)">Add to Cart</button><br>
            - TikTok Likes: 0.4$ / 1,000 
            <input type="number" id="likes-quantity" placeholder="Qty (e.g., 2000)" min="1" oninput="updatePrice('TikTok Likes', 0.4, 'likes-quantity')">
            <span class="price-display" id="price-likes">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('TikTok Likes', 0.4, document.getElementById('likes-quantity').value)">Add to Cart</button><br>
            - TikTok Views: 0.0035$ / 1,000 
            <input type="number" id="views-quantity" placeholder="Qty (e.g., 10000)" min="1" oninput="updatePrice('TikTok Views', 0.0035, 'views-quantity')">
            <span class="price-display" id="price-views">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('TikTok Views', 0.0035, document.getElementById('views-quantity').value)">Add to Cart</button><br>
            - TikTok Saves: 0.65$ / 1,000 
            <input type="number" id="saves-quantity" placeholder="Qty (e.g., 10000)" min="1"  oninput="updatePrice('TikTok Saves', 0.65, 'saves-quantity')">
            <span class="price-display" id="price-saves">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('TikTok Saves', 0.65, document.getElementById('saves-quantity').value)">Add to Cart</button><br>
            - TikTok Shares: 0.65$ / 1,000 
            <input type="number" id="shares-quantity" placeholder="Qty (e.g., 10000)" min="1"  oninput="updatePrice('TikTok Shares', 0.65, 'shares-quantity')">
            <span class="price-display" id="price-shares">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('TikTok Shares', 0.65, document.getElementById('shares-quantity').value)">Add to Cart</button>            
        ...
        serviceText = `
            ...
            - Instagram Likes: 0.2$ / 1,000 
            <input type="number" id="likes-quantity-instagram" placeholder="Qty (e.g., 2000)" min="1"  oninput="updatePrice('Instagram Likes', 0.2, 'likes-quantity-instagram')">
            <span class="price-display" id="price-likes-instagram">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('Instagram Likes', 0.2, document.getElementById('likes-quantity-instagram').value)">Add to Cart</button><br>
            - Instagram Views: 0.06$ / 1,000 
            <input type="number" id="views-quantity-instagram" placeholder="Qty (e.g., 10000)" min="1"  oninput="updatePrice('Instagram Views', 0.06, 'views-quantity-instagram')">
            <span class="price-display" id="price-views-instagram">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('Instagram Views', 0.06, document.getElementById('views-quantity-instagram').value)">Add to Cart</button><br>
            - Instagram Saves: 0.15$ / 1,000 
            <input type="number" id="saves-quantity-instagram" placeholder="Qty (e.g., 10000)" min="1"  oninput="updatePrice('Instagram Saves', 0.15, 'saves-quantity-instagram')">
            <span class="price-display" id="price-saves-instagram">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('Instagram Saves', 0.15, document.getElementById('saves-quantity-instagram').value)">Add to Cart</button><br>
            - Instagram Shares: 0.35$ / 1,000 
            <input type="number" id="shares-quantity-instagram" placeholder="Qty (e.g., 10000)" min="1"  oninput="updatePrice('Instagram Shares', 0.35, 'shares-quantity-instagram')">
            <span class="price-display" id="price-shares-instagram">Price: $0.00</span>
            <button class="add-to-cart" onclick="addToCart('Instagram Shares', 0.35, document.getElementById('shares-quantity-instagram').value)">Add to Cart</button>
            `
